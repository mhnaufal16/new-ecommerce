    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold">Edit Produk: {{ $product->name }}</h2>
                        ...
                        <div class="card border-0 shadow-sm rounded-4 mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control rounded-3" name="name" value="{{ old('name', $product->name) }}" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Deskripsi Singkat <span class="text-danger">*</span></label>
                                    <textarea class="form-control rounded-3" name="short_description" rows="2" required>{{ old('short_description', $product->short_description) }}</textarea>
                                </div>
                                <div class="mb-0">
                                    <label class="form-label fw-bold">Deskripsi Lengkap <span class="text-danger">*</span></label>
                                    <textarea class="form-control rounded-3" name="description" rows="5" required>{{ old('description', $product->description) }}</textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control rounded-end-3" name="price" value="{{ old('price', $product->activePrice->base_price ?? 0) }}" min="0" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Stok <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control rounded-3" name="quantity" value="{{ old('quantity', $product->inventory->quantity ?? 0) }}" min="0" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">SKU <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control rounded-3" name="sku" value="{{ old('sku', $product->sku) }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card border-0 shadow-sm rounded-4">
                            ...
                            <div class="card-body text-center">
                                <img src="{{ $product->thumbnail_url }}" class="img-thumbnail mb-3" style="max-height: 150px;">
