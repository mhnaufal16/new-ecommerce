{{-- resources/views/products/new-arrivals.blade.php --}}
@extends('layouts.app')
...
<div class="container py-5">
    ...
    <h1 class="h3 mb-4">Produk Terbaru</h1>

    @if($products->isEmpty())
        <div class="card border-0 shadow-sm rounded-4 py-5 text-center">
            <div class="card-body">
                <i class="fas fa-box-open fa-4x text-muted opacity-25 mb-4"></i>
                <h5>Belum ada produk baru</h5>
                <p class="text-muted mb-4">Silakan cek kembali nanti untuk produk terbaru kami.</p>
            </div>
        </div>
    @else
        <div class="row g-4">
